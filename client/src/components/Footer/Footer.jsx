...
//                             <li><Link to="/shipping" className="hover:text-amber-300 transition-colors">Shipping</Link></li>
//                         </ul>
//                     </div>
//                     <div>
//                         <h4 className="text-lg font-semibold mb-4">Categories</h4>
//                         <ul className="space-y-2">
//                             <li><Link to="/category/handbags" className="hover:text-amber-300 transition-colors">Handbags</Link></li>
//                             <li><Link to="/category/watches" className="hover:text-amber-300 transition-colors">Watches</Link></li>
//                             <li><Link to="/category/jewelry" className="hover:text-amber-300 transition-colors">Jewelry</Link></li>
//                             <li><Link to="/category/shoes" className="hover:text-amber-300 transition-colors">Shoes</Link></li>
//                         </ul>
//                     </div>
//                     <div>
...
//                     </div>
//                 </div>
//                 <div className="mt-8 pt-8 border-t border-purple-300 text-center">
...
// Updated Footer.jsx with improved presentation and alignment with the website's color scheme

// Updated Footer.jsx with less bright color scheme
