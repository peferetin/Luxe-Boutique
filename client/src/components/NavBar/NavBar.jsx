...
const NavBar = () => {
    ...
    return (
        ...
        //                 <div className="">
        //                     <div className=" ">
        //                         <p className="flex h-2 w-2 items-center justify-center rounded-full bg-red-500 p-2 text-xs text-white">{cart ? cart.products.length : ''}</p>
        //                     </div>
        ...
        <header className="flex justify-between px-10 py-3 border-b border-gray-700 bg-gray-800 text-white w-full">
            ...
            <nav className="flex flex-1 gap-5 pl-20 justify-around">
                <div className="flex gap-5 justify-between py-2.5 text-sm font-medium leading-5 whitespace-nowrap">
                ...
                <Link to='/carts'>
                    <div className="flex justify-center items-center">
                        <p className="flex h-2 w-2 items-center justify-center rounded-full bg-red-600 p-2 text-xs text-white">{cart ? cart.products.length : ''}</p>
