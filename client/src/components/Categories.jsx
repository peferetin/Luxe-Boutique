...
//                 <h1 className="text-center font-bold text-3xl text-indigo-600 mb-6">Categories</h1>
//                 <form className="text-center mb-6" onSubmit={handleSearch}>
//                     <input type="text" placeholder="Search category..." className="p-2 border border-gray-300 rounded-l-md" onChange={e => setSearchCategory(e.target.value)} />
//                     <button onClick={handleSearch} type='submit' className="p-2 bg-indigo-600 text-white rounded-r-md">Search</button>
//                 </form>
