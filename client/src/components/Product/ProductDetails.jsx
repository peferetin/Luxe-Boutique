...
//                 <Button style={{ backgroundColor: '#34D399' }} onClick={userData ? () => addToCart(userData._id, products._id, selectedQuantity, products.price) : () => alert('You need to be connected to add product to the cart')}
//                     ripple={true}
//                     fullWidth={true}
