  ...
  return (
    <>
      <form
        ...
        className="flex relative mt-8 max-w-full rounded-xl w-[480px] max-md:flex-wrap"
      >
      ...
      {searchResults && (
        ...
        <Card className="w-72 bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-shadow duration-300 ease-in-out m-4">
          ...
          <CardBody onClick={() => navigate(`/products/${product._id}`)} className="cursor-pointer p-4">
          ...
          <CardFooter className="pt-0">
            <Button onClick={() => navigate(`/products/${searchResults._id}`)}
              ripple={false}
              fullWidth={true}
